...
def MainMenu():
	addDir('Theme Menu','',1,addon_icon,addon_fanart,local_string(30001),isFolder=True)
	addDir('Tools','',5,addon_icon,addon_fanart,local_string(30002),isFolder=True)
	addDir('Wipe Clean','',4,addon_icon,addon_fanart,local_string(30003),isFolder=False)
	addDir('Messages','',100,addon_icon,addon_fanart,'Bring up the notifications dialog',isFolder=False)
