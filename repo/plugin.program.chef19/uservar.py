...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Chef[/B][/COLOR][COLOR {color1}] Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing The Chef Matrix Wizard.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR blue][B]Diggz[/B][/COLOR] Matrix Wizard'
