...
ORDER = ['fenrd', 'fenpm', 'fenad', 'umbrellard', 'umbrellapm', 'umbrellaad', 'serenrd', 'serenpm', 'serenad', 'rurlad', 'rurlrd', 'rurlpm']

DEBRIDID = {
    'fenrd': {
        'name': '[COLOR blue][B]*FEN REAL DEBRID*[/B][/COLOR]',
        ...
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'fenrd_realdebrid'),
    ...
    'fenpm': {
        'name': '[COLOR blue][B]*FEN Premiumize[/B][/COLOR]',
        'plugin': 'plugin.video.fen',
        'saved': 'fenpm',
        'path': os.path.join(CONFIG.ADDONS, 'plugin.video.fen'),
        'icon': os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'icon.png'),
        'fanart': os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'fanart.jpg'),
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'fenpm_pm'),
        'settings': os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
        'default': 'pm.account_id',
        'data': ['pm.token', 'pm.enabled', 'pm.account_id'],
        'activate': 'RunPlugin(plugin://plugin.video.fen/?mode=premiumize.authenticate)'},
    'fenad': {
        'name': '[COLOR blue][B]*FEN All Debrid[/B][/COLOR]',
        'plugin': 'plugin.video.fen',
        'saved': 'fenad',
        'path': os.path.join(CONFIG.ADDONS, 'plugin.video.fen'),
        'icon': os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'icon.png'),
        'fanart': os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'fanart.jpg'),
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'fenad_ad'),
        'settings': os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
    ...
    'umbrellard': {
        'name': '[COLOR blue][B]Umbrella Real Debrid[/B][/COLOR]',
        ...
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'umbrellard_realdebrid'),
        'settings': os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
        'default': 'realdebridusername',
        'data': ['realdebridtoken', 'realdebrid.enable', 'realdebridusername', 'realdebrid.clientid', 'realdebridrefresh', 'realdebridsecret'],
        'activate': 'RunPlugin(plugin://plugin.video.umbrella/?action=rd_Authorize)'},  
    'umbrellapm': {
        'name': '[COLOR blue][B]Umbrella Premiumize[/B][/COLOR]',
        'plugin': 'plugin.video.umbrella',
        'saved': 'umbrellapm',
        'path': os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella'),
        'icon': os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'icon.png'),
        'fanart': os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'fanart.jpg'),
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'umbrellapm_pm'),
        'settings': os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
        'default': 'premiumizeusername',
        'data': ['premiumize.enable', 'premiumizetoken', 'premiumizeusername'],
        'activate': 'RunPlugin(plugin://plugin.video.umbrella/?action=pm_Authorize)'}, 
    'umbrellaad': {
        'name': '[COLOR blue][B]Umbrella All Debrid[/B][/COLOR]',
        'plugin': 'plugin.video.umbrella',
        'saved': 'umbrellaad',
        'path': os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella'),
        'icon': os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'icon.png'),
        'fanart': os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'fanart.jpg'),
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'umbrellaad_ad'),
        'settings': os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
        'default': 'alldebridusername',
        'data': ['alldebrid.enable', 'alldebridtoken', 'alldebridusername'],
