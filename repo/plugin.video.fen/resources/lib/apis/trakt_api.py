...
def trakt_collection(media_type, page_no):
	...
	if settings.paginate(): final_list, all_pages, total_pages = paginate_list(original_list, page_no, settings.page_limit())
...
def trakt_fetch_movie_sets():
	...
	return trakt_cache.cache_trakt_object(_process, 'trakt_movie_sets', collection_info)
