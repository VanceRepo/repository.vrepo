...
default_easynews_icon, fanart, fen_clearlogo = kodi_utils.get_icon('easynews'), kodi_utils.addon_fanart, kodi_utils.addon_clearlogo
down_str = ls(32747)
...
def search_easynews(params):
	...
	if not kodi_utils.external_browse(): kodi_utils.set_view_mode('view.premium')
